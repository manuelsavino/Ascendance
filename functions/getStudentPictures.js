    ...
    if (record.fields.Costumes) {
      ...
      const costumes = allDatacostumes.map(costume => {
        return {
          ...
          pictureDay: costume.fields["Picture Day and Time"],
          hairVideo: costume.fields["Hair Video URL"] || null,
          makeupVideo: costume.fields["Makeup Video URL"] || null,
          order: costume.fields.OrderNumber,
